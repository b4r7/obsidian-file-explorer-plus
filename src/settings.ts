...
export default class FileExplorerPlusSettingTab extends PluginSettingTab {
    ...
    display(): void {
		...
		new Setting(this.containerEl)
            ...
            .addToggle((toggle) => {
                toggle
                    ...
                    .onChange((isActive) => {
                        ...
                        this.plugin.settings.moveIconsToMargin = isActive;
				...
				new Setting(this.containerEl)				
				.setName("Move icons to the margin")
				.setDesc("(Only possible when above setting is enabled)")
				.addToggle((toggle) => {
					toggle
						.setValue(this.plugin.settings.moveIconsToMargin)
						.onChange((isActive) => {
				...
				.setDisabled(!this.plugin.settings.hidePrefixIfIcon)
			...
			new Setting(this.containerEl)
            .setName("Color pinned folder toggles")            
            .addToggle((toggle) => {
                toggle
